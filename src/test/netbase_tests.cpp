...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:17200", "127.0.0.1", 17200));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:17200", "127.0.0.1", 17200));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:17200", "::ffff:127.0.0.1", 17200));
    BOOST_CHECK(TestSplitHost("[::]:17200", "::", 17200));
    BOOST_CHECK(TestSplitHost("::17200", "::17200", -1));
    BOOST_CHECK(TestSplitHost(":17200", "", 17200));
    BOOST_CHECK(TestSplitHost("[]:17200", "", 17200));
